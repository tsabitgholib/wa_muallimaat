...
class UserController extends Controller
{
    public function __construct()
    {
        ...
        $this->title = 'Cukai';
        $this->mainTitla = 'Data Jasa Pengguna';
        $this->showTitle = 'Detail Data Jasa Pengguna';
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.users.dataUser', $data);
    }
...
//        dd($request->get('order'));
        ...
        foreach ($records as $record) {
            $detailRoute = route('admin.users.show', $record->item_id);
            $data_arr[] = array(
                "no" => $numberStart,
