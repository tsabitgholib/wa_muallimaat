...
final class Messages
{
    ...
    public static function wa($message)
    {
        ...
        $pesan = [
            ...
            "Assalamualaikum Wr Wb,\nBada tahmid, tahlil dan shalawat bagi kita semua. Kami ingin menginformasikan kepada Anda, orang tua ananda {nama_anak}, untuk $message anak Anda sebesar {jumlah_tagihan}.\nDengan Rincian :{rincian}\nDemikian pesan dari kami. Wassalam 🙏.\n\n*_*pesan otomatis dari " . config('app.nama_instansi') . "_*\n*_*Silahkan menghubungi bagian keuangan jika ada kesalahan tagihan atau nama siswa_*",
        ];
        return $pesan;
    }
}
